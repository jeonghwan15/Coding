// //문자열
// // 자바스크립트에서 문자열은 String객체 라는 것으로 저장이 되고
...
// var at = word.charAt(3);    //0부터 시작 member 0(m) 1(e) 2(m) 3(b)
// console.log( at);

// // 3. 문자열에서 특정문자 또는 문자열이 있냐? 어디에 있냐? - index0f()
// word = "i like html";
// var idx = word.indexOf("like");  //맨 앞부터 가장 가까운 문자 찾기
// console.log( idx );
// if( word.indexOf("love")==-1){ //문자열에 검색문자 또는 물자열이 없다면 -1
...
// // 다른 문자를 제거하기 위해 사용하기도 함
// word = "i like css like like";
// var word2 = word.replace("like", "love"); //원본 변경 X -> word2 O 
// console.log( word2 );
...
// //  g - global 문자역 내 모든 패턴 검색
// //  m - multi line 문자열의 행이 바뀌더라도 검색을 계속한다.
// //  s - 모든 문자 검색(특수문자 포함)  :  특수문자( \n, \r, \t, \p, \a 등등)
// //  u - 유니코드 검색  (  %2b%11%ab%ac%15%a2 )  ->  정규표현식으로 변환해서 검색           
// //  y - sticky  문자열 내 특정 위치에서 검색을 진행

// console.log ( test.match ( /cat/g ));
// word = "banana \n apple \n member!!";
// console.log( word.match( /^apple/gm ));  //  ^apple : 문장이 apple로 시작하는 지 검사
...
// console.log( word.replace(/..살/g, '30살'));
...
// console.log( word.slice(-3));   //뒤부터 0
// console. log( word.slice( -3, -2));  // 음수 사용 시 0이나 양수 불가
...
// // 15. 문자열로 변환 - toString()
// var num = 100;
// console.log( typeof num.toString() );  // typeof 타입 알려줌 

// var birth = 19990101;
// // birth/10000     substring 문자열 X
...
//     .indexOf(문자열) - 문자열에서 특정문자 또는 문자열이 몇번째 있는 지 알려준다. 없으면 -1
//     .lastIndexOf(문자열) - 문자열의 끝에서 문자 또는 문자열 몇번쨰 있는 지 검색
...
//     .trim() - 문자열의 양쪽끝 공백제거
//     .starsWith(문자열), endsWith(문자열) - 문자열의 시작과 끝이 특정 문자열로 시작하는 지 여부
//     .toString() - 문자열로 변환
...
console.log( parseInt(age)); // parseInt()- 앞쪽에 있는 숫자만 정수로변환