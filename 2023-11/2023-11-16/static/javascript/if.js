//if문 - 조건식의 참, 거짓에 의해 실행될 내용을 실행 시킨다.
/* 

if( 조건식 ){
    참일 경우 실행할 내용
}
if뒤에 작은괄호 열어서 안에 조건식을 작성한다. 조건식 뒤에는 중괄호를 열어서
...
// var num=20; //num이라는 공간에 20을 저장해라.
...
//  var user = parseInt(prompt("1.가위 2.바위 3.보"));
    ...
    //세개의 정수를 입력받아 가장 작은수 출력, 모두 같다 출력
    ...
    //     alert("모두 같은숫자")
    // }else if(( num1<num2 || num1<num3) && (num1<num3 || num1==num3)){
    //     alert("작은수 : " + num1);
    ...
    // var coin = Math.floor(Math.ranom()*2)+1;


    // //javascript html태그 선택방법
    // var front = doccument.getElementById("front")
    // var back = doccument.getElementById("back")
